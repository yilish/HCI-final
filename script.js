...
function createBirds()
{
  ...
  bird1.threegroup.position.x = 0;
   bird1.threegroup.position.y = 180;
  bird1.threegroup.scale.set(1.5,1.5,1.5);
  
  scene.add(bird1.threegroup);
  
  bird2 = new Bird();
  bird2.threegroup.position.x = -250;
  bird2.threegroup.position.y = 180;
  bird2.side = "right";
  ...
  bird3.threegroup.position.y = 180;
  bird3.side = "left";
...
function loop(){
  ...
  render();
requestAnimationFrame(loop);//控制动画播放
}
